...
export default {
  ...
  theme: {
    ...
    fontSize: {
      "h-xl": [
        "100px",
        { lineHeight: "110px", fontWeight: "700", fontFamily: "roboto" },
      ], // desktop hero text
      "h-lg": [
        "70px",
        { lineHeight: "86px", fontWeight: "700", fontFamily: "roboto" },
      ], // desktop title
      "h-l": [
        "56px",
        { lineHeight: "64px", fontWeight: "700", fontFamily: "roboto" },
      ], // desktop title
      "h-md": [
        "35px",
        { lineHeight: "45px", fontWeight: "700", fontFamily: "roboto" },
      ], // desktop sub title
      "h-sm": [
        "30px",
        { lineHeight: "35px", fontWeight: "700", fontFamily: "roboto" },
      ], // desktop sub title
      "h-xs": [
        "25px",
        { lineHeight: "35px", fontWeight: "400", fontFamily: "roboto" },
      ], // desktop sub title
      "b-md": [
        "25px",
        { lineHeight: "45px", fontWeight: "700", fontFamily: "roboto" },
      ...
      "p-lg": [
        "20px",
        { lineHeight: "26px", fontWeight: "400", fontFamily: "roboto" },
      ], // desktop text
      "p-sm": [
        "18px",
        { lineHeight: "24px", fontWeight: "400", fontFamily: "roboto" },
      ], // mobile text
